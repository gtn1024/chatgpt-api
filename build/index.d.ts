...
declare class ChatGPTAPI {
     ...
     */
    sendMessage(text: string | openai.ChatCompletionRequestMessage[], opts?: SendMessageOptions): Promise<ChatMessage>;
    get apiKey(): string;
    set apiKey(apiKey: string);
    get apiOrg(): string;
    set apiOrg(apiOrg: string);
    protected _buildMessages(text: string | openai.ChatCompletionRequestMessage[], opts: SendMessageOptions): Promise<{
        messages: openai.ChatCompletionRequestMessage[];
        maxTokens: number;
        numTokens: number;
    }>;
    protected _getTokenCount(textOrMessages: string | openai.ChatCompletionRequestMessage[]): Promise<number>;
